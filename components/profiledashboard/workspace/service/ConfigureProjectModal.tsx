    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
                <Button className="flex items-center gap-2 bg-blue-500 hover:bg-blue-700 text-white focus:ring-2 focus:ring-blue-700 focus:ring-offset-2" onClick={() => setOpen(true)}>
