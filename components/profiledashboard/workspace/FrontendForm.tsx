...
export function FrontendForm({
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            //         title: "Error",
            //         description:
            //             result?.data?.message || "Failed to create frontend service deployment. Please try again.",
            //         variant: "error",
            //         duration: 5000,
            //     });
            // }
            ...
            if (error?.status === "PARSING_ERROR" && error?.originalStatus === 200) {
                ...
                toast({
                    title: "Error",
                    description:
                        error?.data?.message || "Failed to create frontend service deployment. Please try again.",
                    variant: "error",
                    duration: 5000,
                });
            } else {
