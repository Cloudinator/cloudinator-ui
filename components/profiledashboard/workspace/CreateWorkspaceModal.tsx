...
export function CreateWorkspaceModal() {
  ...
  const hasWorkspace = workspacesData && workspacesData.length > 0;

  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button
          className={`bg-purple-500 text-primary-foreground hover:bg-purple-700 ${
            hasWorkspace ? "opacity-50 pointer-events-none" : ""
          }`}
