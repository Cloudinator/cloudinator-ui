...
import {ConfettiFireworks} from "@/components/profiledashboard/workspace/ConfettiFireworks";
import {FailureTrigger} from "@/components/profiledashboard/workspace/FailureTrigger";
  ...
  const connectToEventSource = () => {
    ...
    eventSourceRef.current.onmessage = (event) => {
      ...
      if (newLogs.some((log: string) => log.includes("Finished: FAILURE"))) {
        ...
        // Trigger confetti animation
        setShowFailure(true); // Use state to control the confetti animation
      ...
      <div className="container mx-auto px-4 py-8 bg-gray-50 dark:bg-gray-900 min-h-screen">
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
          ...
          >
            ...
            {showFailure && <FailureTrigger autoTrigger={true} />}
