    ...
    <section className="container mx-auto px-4 pb-24 pt-16">
      <div className="grid gap-8 lg:grid-cols-[1fr,1.5fr] items-center justify-center">
        <div className="space-y-4 text-center">
          ...
          <div className="relative h-[300px] w-[300px] ml-16">
            <Image
              src="/whyus.png"
        ...
        <div className="grid gap-4 sm:grid-cols-2 justify-items-center">
          <Card className="bg-purple-600 text-white transition-all duration-300 ease-in-out hover:bg-purple-700 hover:scale-105 hover:shadow-xl">
            <CardContent className="p-6 space-y-2 text-center">
              ...
              <p className="text-purple-100">
                ...
                to deliver solutions that meet your unique needs.
              </p>
            </CardContent>
          </Card>
          <Card className="bg-purple-600 text-white transition-all duration-300 ease-in-out hover:bg-purple-700 hover:scale-105 hover:shadow-xl">
            <CardContent className="p-6 space-y-2 text-center">
              ...
              <p className="text-purple-100">
                ...
                the industry to give you the best and innovative solutions.
              </p>
            </CardContent>
          </Card>
          <Card className="bg-purple-600 text-white transition-all duration-300 ease-in-out hover:bg-purple-700 hover:scale-105 hover:shadow-xl">
            <CardContent className="p-6 space-y-2 text-center">
              ...
              <p className="text-purple-100">
                We help to personalize approaches to every project, working
                closely with you to understand your business and deliver
                specific solutions.
              </p>
            </CardContent>
          </Card>
          <Card className="bg-purple-600 text-white transition-all duration-300 ease-in-out hover:bg-purple-700 hover:scale-105 hover:shadow-xl">
            <CardContent className="p-6 space-y-2 text-center">
              ...
              <p className="text-purple-100">
                Our track record speaks for itself – we deliver successful
                outcomes and maintain lasting relationships with our satisfied
                clients.
              </p>
            </CardContent>
          </Card>
