    ...
    return (
        <div className="py-8 px-8">
            ...
            <div className="grid gap-6 md:grid-cols-3 mt-6">
                ...
                <Card>
                    <CardHeader>
                        <CardTitle className="text-xl font-semibold text-purple-500">Quick Actions</CardTitle>
                    </CardHeader>
                                            ...
                                            <TableCell>
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <Badge
                                                        ...
                                                        className={
                                                            build.status.toLowerCase() === 'success'
                                                                ? 'bg-green-500 hover:bg-green-700' // Green for success
                                                                : build.status.toLowerCase() === 'failure'
                                                                    ? 'bg-red-500 hover:bg-red-700' // Red for failure
                                                                    : 'bg-yellow-500 hover:bg-yellow-700' // Yellow for other statuses (e.g., building)
                                                        }
                                                    >
                                                        {build.status}
                                                    </Badge>
