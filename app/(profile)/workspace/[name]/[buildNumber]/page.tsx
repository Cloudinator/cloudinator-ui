...
const LogPage = (props: PropsParams) => {
  ...
  useEffect(() => {
    ...
    eventSourceRef.current.onerror = (error: Event) => {
      ...
      if (eventSourceRef.current?.readyState === EventSource.CLOSED) {
        ...
        setProgress(100); // Ensure progress is 100% when deployment ends
      } else {
        setIsDeploying(false);
        setProgress(100); // Ensure progress is 100% even if there's an error
      }
  ...
  return (
    <div className="px-8 py-8 bg-gray-50 dark:bg-gray-900 w-full h-screen">
      <Breadcrumbs />
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
        <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md flex items-center justify-between">
          <div className="flex items-center">
            ...
            <span className="font-semibold dark:text-gray-100">Total Logs</span>
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md flex items-center justify-between">
          <div className="flex items-center">
            ...
            <span className="font-semibold dark:text-gray-100">Errors</span>
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md flex items-center justify-between">
          <div className="flex items-center">
            ...
            <span className="font-semibold dark:text-gray-100">Warnings</span>
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md flex items-center justify-between">
          <div className="flex items-center">
            ...
            <span className="font-semibold dark:text-gray-100">Info</span>
          </div>
        ...
        >
          ...
          <div className="flex items-center mb-4">
            <input
              ...
              className="flex-1 p-2 rounded-lg bg-gray-200 dark:bg-gray-700 text-gray-900 dark:text-gray-100 border border-gray-300 dark:border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500"
              onChange={(e) => setSearchQuery(e.target.value)}
            />
            <select
              className="ml-2 p-2 rounded-lg bg-gray-200 dark:bg-gray-700 text-gray-900 dark:text-gray-100 border border-gray-300 dark:border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500"
