...
import LoadingRocket from "@/public/LoadingRocket.json";
                          ...
                          {buildNumber.length > 0 && buildNumber[0].status === "BUILDING" ? (
                              ...
                              <>
                                {isRefetching ? (
                                    ...
                                    <>
                                      <Lottie
                                          animationData={LoadingRocket} // Pass the JSON animation
                                          loop={true} // Make the animation loop
                                          style={{ width: 200, height: 200 }} // Set the size of the animation
                                      />
                                      <p className="mt-4 text-gray-600 dark:text-gray-400 text-center">
